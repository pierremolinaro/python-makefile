...
class Make:
  ...
  #--- Build primary dependences
    ...
    for dependence in rule.mDependences:
      ...
      # print ("   dependence " + dependence + " -> " + str (willBeBuilt))
      if willBeBuilt:
  ...
  #--- Check primary file modification dates
    if not appendToJobList:
      ...
      if targetDateModification < rule.mSecondaryMostRecentModificationDate:
        ...
        for dependence in rule.mDependences:
          dependenceDateModification = modificationDateForFile (self.mModificationDateDictionary, dependence)
  ...
  #--- Append to job list
    if appendToJobList:
      ...
      self.mAlreadyBuildTargetSet.add (target)
  #--- Return
